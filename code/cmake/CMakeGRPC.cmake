...
ELSEIF(XDYN_NATIVE_BUILD)
    # grpc++.pc names openssl, re2, c-ares and zlib in Requires, so they must be present
    # for pkg-config to resolve the target
    FIND_PACKAGE(PkgConfig REQUIRED)
    PKG_CHECK_MODULES(GRPCPP REQUIRED IMPORTED_TARGET grpc++)
    SET(GRPC_GRPCPP_UNSECURE PkgConfig::GRPCPP)
    FIND_PROGRAM(GRPC_CPP_PLUGIN_EXECUTABLE grpc_cpp_plugin REQUIRED)
    SET(GRPC_INCLUDE_DIR ${GRPCPP_INCLUDE_DIRS})
    ADD_DEFINITIONS(${GRPCPP_CFLAGS_OTHER})
ELSE()
