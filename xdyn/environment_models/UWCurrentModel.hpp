 ...
 * UWCurrentModel.hpp
 *
 * Base class for underwater current models, following the WindModel pattern.
 */
...
public:
    ...
    /**  \param wave_height z of the free surface above the queried point, in NED (so positive down)
      */
